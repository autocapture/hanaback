package com.aimskr.ac2.kakao.backend.member.web;
...
import com.aimskr.ac2.kakao.backend.member.dto.PasswordChangeDto;
...
public class MemberController {
    ...
    // QA 배당 상태 변경
    @PostMapping("/v2/kakao/member/qaAssign")
    ...
    @GetMapping("/v2/kakao/member/logout")
