...
@Component
public class RprcTotalAmountRule extends ClaimRule {

    private final CacheService cacheService;

    @Override
    public void setItemInfo(DocType docType){
        initItem(ItemType.RPRC_TOTAL_AMOUNT);
    }
    ...
    public void applyRule(List<ValueBox> boxList, List<String> rows, String labelString){
        ...
        String totalAmount = "";
        List<String> identifier = cacheService.getDetailKeywords().get(ItemType.RPRC_TOTAL_AMOUNT);
        log.debug("Rows: {}", rows);
