...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, "/hana/v1/image/update/CIPS").permitAll()
                .antMatchers(HttpMethod.POST, "/hana/v1/image/update/ETCS").permitAll()
                .antMatchers(HttpMethod.GET, "/hana/v1/member/list").permitAll()
                .antMatchers(HttpMethod.GET, "/hana/v1/member/qa").permitAll()
                .antMatchers(HttpMethod.POST, "/hana/v1/member/save").permitAll()
                .antMatchers(HttpMethod.PUT, "/hana/v1/member/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/hana/v1/member/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/hana/v1/reply2").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/hana/v1/assign/get").permitAll()
